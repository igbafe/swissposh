      ...
      <div className="pb-10">
        <div className="lg:flex-row flex-col flex items-center lg:items-start gap-4 justify-center">
          <div className="h-[565px] w-[680px] max-md:h-[443px] max-md:w-[327px] border  ">
            ...
            <form
              action=""
              className="flex flex-col max-md:gap-2 gap-4 max-md:p-4 p-6"
            >
              <h1 className="text-xs max-md:text-[10px] font-medium">
                Email Address
              </h1>
              <p className="text-xs max-md:text-[10px] font-medium">
                wakaooluwajuwon@watlook.com
              </p>
              <div>
                <label
                  className="text-xs max-md:text-[10px]"
                  htmlFor="password"
                >
                  Password *
                </label>
                <input
                  type="text max-md:text-[10px]"
                  className="border h-10 w-[610px] max-md:w-[297px]"
                />
              </div>
              <div>
                <label
              ...
              <div className="p-5">
                ...
                <div className="text-xs max-md:text-[10px] max-w-[400px] pb-4">
                  <p>
                    ...
                    with the SWISSPOSH Privacy Notice.
                  </p>
                </div>
                <div className="text-xs max-md:text-[10px] text-center bg-[#E4E4E4] items-center">
                  <button className=" w-[403px] max-md:w-[249px] h-[38px]">
                    Proceed To Payment
                  </button>
                </div>
              </div>
