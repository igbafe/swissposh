  ...
  return (
    <div className=" h-full w-full flex justify-center items-center">
      <div className="flex h-[435px] w-[211px] gap-3 md:w-[432px] flex-col justify-center text-center items-center">
        <p className="md:text-[150px] text-[73px] text-[#F20000] font-black">
          Oops
        </p>
        ...
        <button className="md:h-[40px] h-[23px] w-[133px] md:w-[222px] md:text-[16px] text-[9px] bg-[#001F3F] text-white">
          {" "}
