...
import { remove } from "../components/store/CartSlice"; // Adjust the import path as needed
import "react-toastify/dist/ReactToastify.css";
import { FiHeart } from "react-icons/fi";
import { GoDotFill } from "react-icons/go";
import womenImages from "../components/data/women";
...
function Favourites() {
  ...
  const notify = () => toast("Item has been removed");
            ...
            >
              ...
              <div className="flex justify-between items-center">
                ...
                <div>
                  ...
                  <button
                    className="sm:text-[8px] text-[4.3px] font-black bg-[#8B0000] p-1 text-white"
